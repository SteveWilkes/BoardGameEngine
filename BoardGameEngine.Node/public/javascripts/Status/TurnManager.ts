module AgileObjects.BoardGameEngine.Status {
    ...
    export class TurnManager {
        ...
        constructor(turnDefinition: I.TurnDefinition, private _game: G.Game) {
            ...
            this.regulator = new Interactions.TurnRegulator(turnDefinition, this._game);
            this._teams = new Array<T.Team>();
        }

        public currentTeam: T.Team;
        public regulator: I.IPieceInteractionRegulator;
