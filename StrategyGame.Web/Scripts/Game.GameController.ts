    ...
    class GameController {
        constructor($window: ng.IWindowService, $pieceFactory: PieceFactory, $scope: IGameScope) {
            ...
            var team1TileConfigs = [
                ...
                new BoardTileConfig(coordinatesRegistry.get(3, 1), $pieceFactory.createPiece("1")), // row 2
                ...
                new BoardTileConfig(coordinatesRegistry.get(4, 1), $pieceFactory.createPiece("1")), // row 3
                ...
                new BoardTileConfig(coordinatesRegistry.get(5, 1), $pieceFactory.createPiece("1")), // row 4
                new BoardTileConfig(coordinatesRegistry.get(4, 2), $pieceFactory.createPiece("1")),
                new BoardTileConfig(coordinatesRegistry.get(3, 3), $pieceFactory.createPiece("1")),
                new BoardTileConfig(coordinatesRegistry.get(2, 4), $pieceFactory.createPiece("1")),
                new BoardTileConfig(coordinatesRegistry.get(1, 5), $pieceFactory.createPiece("1"))];
